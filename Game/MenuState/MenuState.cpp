...
void MenuState::Init(){
    _data->assetManager.LoadTexture("Background", "assets/Background.png");
    ...
    _data->assetManager.LoadTexture("PLAY_WITH_FRIEND", "assets/MenuAssets/Buttons/buttonMenu1.png");
    _data->assetManager.LoadTexture("PLAY_WITH_FRIEND_HOVER", "assets/MenuAssets/Buttons/buttonMenu1_hover.png");
    _playWithFriendSprite.setTexture(_data->assetManager.GetTexture("PLAY_WITH_FRIEND"));
    _playWithFriendSprite.setPosition(120, 30);

    _data->assetManager.LoadTexture("BUTTON_PLAY_AI", "assets/MenuAssets/Buttons/PlayWithAI_button.png");
...
void MenuState::HandleInput() {
    ...
    while (_data->window.pollEvent(event)) {
        ...
        if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left) {
            ...
            if(_data->inputManager.IsSpriteClickedAccurate(_playWithFriendSprite, sf::Mouse::Left, _data->window)) {
            ...
            else if (_data->inputManager.IsSpriteClickedAccurate(_playWithAISprite, sf::Mouse::Left, _data->window)) {
...
void MenuState::UpdateSpriteTexture(sf::Sprite& sprite, const std::string& normalTexture, const std::string& hoverTexture) {
    if (_data->inputManager.IsSpriteHoverAccurate(sprite, sf::Mouse::Left, _data->window)) {
